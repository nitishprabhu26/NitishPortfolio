  ...
  render() {
    ...
    if(this.props.data){
      var education = this.props.data.education.map(function(education){
        ...
        <p className={(education.description ? 'unset-margin-bottom text-justification' : "hideDisplay unset-margin-bottom text-justification")} ><strong>Majors: </strong>{education.description}</p>
        <p className={(education.courses ? 'text-justification' : "hideDisplay text-justification")} ><strong>Related Courses: </strong>{education.courses}</p></div>
      })
